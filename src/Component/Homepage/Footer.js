    ...
    <footer className="footer-container">
      <div className="footer-section">
        ...
        <div className="media-icons-for-footer">
          <span style={{marginRight:"1rem", marginTop:"0.5rem"}}>Connect with us At: </span>
          <a href="https://www.facebook.com/profile.php?id=100089333944954&mibextid=LQQJ4d" rel="noreferrer" target="_blank">
            <FontAwesomeIcon icon={faFacebookF} />
          </a>
          {/* <a href="#">
            <FontAwesomeIcon icon={faTwitter} />
          </a> */}
          <a href="https://instagram.com/gulabvadi_and_nursery?igshid=YmMyMTA2M2Y=" rel="noreferrer" target="_blank">
